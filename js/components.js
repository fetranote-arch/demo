...
<nav class="navbar transparent">
  <div class="nav-inner">
    <a href="index.html" class="nav-logo">
      ...
      <div class="nav-logo-text">AL AQEEQ<small>GLASS &amp; ALUMINIUM</small></div>
    </a>
    <ul class="nav-links">
    ...
    <div class="footer-grid">
      <div>
        ...
        <div class="social-row">
          <a href="https://web.facebook.com/profile.php?id=61560623292780" target="_blank" class="social-ico" aria-label="Facebook">
          ...
          <a href="https://www.instagram.com/alaqeeq110/" target="_blank" class="social-ico" aria-label="Instagram">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="18" height="18"><rect x="2" y="2" width="20" height="20" rx="5"/><circle cx="12" cy="12" r="4"/><circle cx="17.5" cy="6.5" r="1" fill="currentColor"/></svg>
          </a>
          <a href="https://wa.me/261340223002" target="_blank" class="social-ico" aria-label="WhatsApp">
            ${WA_ICON}
          </a>
        </div>
      </div>
